...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Social Studies Bee</title>
	...
	<body class="homepage">
		...
		<div id="header">
			<div class="container"> 
				...
				<nav id="nav">
					<ul>
						<li class="active"><a href="../Scientist/Science.php">Science</a></li>
		...
		<div id="main">
			<div class="container">
				<div class="row"> 
					...
					<div id="content" class="12u skel-cell-important">
						<section>
							<header>
								<h2 style = "text-align: center;">Snakey the Scientist</h2>
							</header>
            ...
            <div id="licenseContainer">
                ...
                <div>
                    <span xmlns:dct="http://purl.org/dc/terms/" property="dct:title" id="gameTitleSpan">This game</span> by <span xmlns:cc="http://creativecommons.org/ns#" property="cc:attributionName">Fox Valley Technical College</span> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by/4.0/">Creative Commons Attribution 4.0 International License</a>.
                            <p>
